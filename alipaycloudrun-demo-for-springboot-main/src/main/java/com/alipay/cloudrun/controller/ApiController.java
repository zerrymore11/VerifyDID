...
public class ApiController {
	@GetMapping("/issuer")
	public ServiceResponse<String> sendingVCData(String student_ID, String name, String pubKey) throws Exception{
        ...
        if (vc.member_ID.equals("-")) {
            ...
            String cypherText = encrypter.encrypt(rvc.Costumer_DID_data, "-", plainText);
